        ...
        if(Core.svgHandler.getLandOwner(defendId) == Core.getPlayerName()){
            ...
            if(parseInt(Core.svgHandler.getLandUnitcount(attackId)) == 1){
                ...
                OverlayString = OverlayString + '</td>\n\
                                    ...
                                    "<button style='margin-top: 20px;' id='startAttack' name='StartAttack' onClick='Core.attackHandler.showAttack(\""+attackId+"\",\""+defendId+"\",\""+difference+"\")'>Nochmal Angreifen</button>"+
