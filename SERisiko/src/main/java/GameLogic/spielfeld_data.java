...
class spielfeld_data {
	...
	static Spielwelt init_spielwelt_europa(Spieler[] spieler){
		...
		laender[0]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Russland", get_russland());
		laender[1]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Finnland", get_finnland());		
		laender[2]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Schweden", get_sweden());
		laender[3]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Norwegen", get_norway());
		laender[4]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Ukraine", get_ukraine());
		laender[5]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Italien", get_italy());
		laender[6]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Frankreich", get_france());
		laender[7]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Spanien", get_spain());
		laender[8]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Grichenland", get_greece());
		laender[9]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Deutschland", get_germany());
		laender[10]=new Land(auswahl_zufall_spieler(spieler,verteilung), "D�nemark", get_daenemark());
		laender[11]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Bosnien", get_bosnien());
		laender[12]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Kroatien", get_croatia());
		laender[13]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Serbien", get_serbien());
		laender[14]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Bulgaria", get_bulgaria());
		laender[15]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Rum�nien", get_romania());
		laender[16]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Moldavien", get_moldova());
		laender[17]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Montenegro", get_montenegro());
		laender[18]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Mazedonien", get_macedonia());
		laender[19]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Portugal", get_portugal());
		laender[20]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Slovenien", get_slovenia());
		laender[21]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Ungarn", get_hungary());
		laender[22]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Slovakai", get_slovakia());
		laender[23]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Tschechen", get_czeck_rep());
		laender[24]=new Land(auswahl_zufall_spieler(spieler,verteilung), "�sterreich", get_austria());
		laender[25]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Schweiz", get_switzerland());
		laender[26]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Polen", get_polland());
		laender[27]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Wei�russland", get_weissrussland());
		laender[28]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Estland", get_estonia());
		laender[29]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Lettland", get_lettland());
		laender[30]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Litauen", get_litauen());
		laender[31]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Niederlande", get_netherlands());
		laender[32]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Belgien", get_belgium());
		laender[33]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Gro�britannien", get_britain());
		laender[34]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Irland", get_ireland());
		laender[35]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Island", get_iceland());
		laender[36]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Albanien", get_albania());
		laender[37]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Kaliningrad", get_kalingrad());
