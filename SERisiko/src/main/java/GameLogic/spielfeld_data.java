...
class spielfeld_data {
	...
	static Spielwelt init_spielwelt_europa(Spieler[] spieler){
		...
		laender[0]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Russland", 0);
		laender[1]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Finnland", 1);
		laender[2]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Schweden", 2);
		laender[3]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Norwegen", 3);
		laender[4]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Ukraine", 4);
		laender[5]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Italien", 5);
		laender[6]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Frankreich", 6);
		laender[7]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Spanien", 7);
		laender[8]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Grichenland", 8);
		laender[9]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Deutschland", 9);
		laender[10]=new Land(auswahl_zufall_spieler(spieler,verteilung), "D�nemark", 10);
		laender[11]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Bosnien", 11);
		laender[12]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Kroatien", 12);
		laender[13]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Serbien", 13);
		laender[14]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Bulgaria", 14);
		laender[15]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Rum�nien", 15);
		laender[16]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Moldavien", 16);
		laender[17]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Montenegro", 17);
		laender[18]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Mazedonien", 18);
		laender[19]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Portugal", 19);
		laender[20]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Slovenien", 20);
		laender[21]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Ungarn", 21);
		laender[22]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Slovakai", 22);
		laender[23]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Tschechen", 23);
		laender[24]=new Land(auswahl_zufall_spieler(spieler,verteilung), "�sterreich", 24);
		laender[25]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Schweiz", 25);
		laender[26]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Polen", 26);
		laender[27]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Wei�russland", 27);
		laender[28]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Estland", 28);
		laender[29]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Lettland", 29);
		laender[30]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Litauen", 30);
		laender[31]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Niederlande", 31);
		laender[32]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Belgien", 32);
		laender[33]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Gro�britannien", 33);
		laender[34]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Irland", 34);
		laender[35]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Island", 35);
		laender[36]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Albanien", 36);
		laender[37]=new Land(auswahl_zufall_spieler(spieler,verteilung), "Kaliningrad", 37);
